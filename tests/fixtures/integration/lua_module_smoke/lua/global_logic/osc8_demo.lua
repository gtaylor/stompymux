local lines = {
  mux.markup("[color=cyan bold]OSC 8 demonstration (Tier 1-6)[/]"),
  mux.markup(
  ...
  mux.markup('Tier 4 - spoiler: [send="look" spoiler]The answer is 42[/]'),
  mux.markup('Tier 4 - reveal-only spoiler: [send="look" spoiler disabled]A secret with no follow-up action[/]'),
  mux.markup(
