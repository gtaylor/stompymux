...
local function access_policy_test(ctx)
  ...
  policy:set("attribute/Description", "Test subject")
  assert(not traverse_passes(exit, enactor, subject))
  subject:attributes():set("Description", "Test subject")
  assert(traverse_passes(exit, enactor, subject))

  policy:set("attribute/Description", nil)
  ...
  policy:set("attribute/Description", true)
  ok, err = pcall(evaluate, exit, subject)
