...
static int write_lua_fixture(const char *directory) {
  ...
  fputs(
      ...
      file);
  fputs("        local list_zone = mux.world.create_thing({\n"
        "          name = \"Lua List Zone\", location = room\n"
        "        })\n"
        "        local other_list_zone = mux.world.create_thing({\n"
        "          name = \"Lua Other List Zone\", location = room\n"
        "        })\n"
        "        local empty_list_zone = mux.world.create_thing({\n"
        ...
        file);
  fputs(
      "        local zoned_kinds = mux.world.list_objects({\n"
  ...
  fputs(
      ...
      "        local created_zoned_room = mux.world.create_room({\n"
      "          name = \"Lua Created Zoned Room\", zone = room_zone\n"
      "        })\n"
      "        local created_thing_zoned_room = mux.world.create_room({\n"
      "          name = \"Lua Created Thing-Zoned Room\", zone = thing_zone\n"
      "        })\n"
      "        local created_nil_zone_room = mux.world.create_room({\n"
      "          name = \"Lua Created Nil-Zone Room\", zone = nil\n"
      "        })\n"
      "        local created_zoned_thing = mux.world.create_thing({\n"
      "          name = \"Lua Created Zoned Thing\", location = room,\n"
      "          zone = room_zone:dbref()\n"
      "        })\n"
      "        local created_zoned_exit = mux.world.create_exit({\n"
  ...
  fputs("        target:set_zone(room_zone)\n"
        ...
        "          mux.world.create_room, { name = \"Bad Zone Dbref\",\n"
        "            zone = 999999 })\n"
        ...
        "          mux.world.create_room, { name = \"Bad Zone Kind\",\n"
        "            zone = exit })\n"
        ...
        "          mux.world.create_thing, { name = \"Bad Going Zone\",\n"
  ...
  fputs("    {\n"
        ...
        "        if still_valid then\n"
        "          for _ = 1, 256 do\n"
        "            local replacement = mux.world.create_thing({\n"
