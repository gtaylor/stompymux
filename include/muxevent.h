...
/* Simplified event adding is more or less irrelevant, most programs
   ...
   though. */
#define muxevent_add_simple_arg(time, func, data)                              \
  muxevent_add(time, 0, 0, func, data, NULL)
#define muxevent_add_simple_noarg(time, func)                                  \
  muxevent_add(time, 0, 0, func, NULL, NULL)
