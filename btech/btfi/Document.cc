...
Document::Document() : serialize_mode(SERIALIZE_NONE) {}
...
void Document::write(Encoder &encoder) const {
...
bool Document::read(Decoder &decoder) {
  switch (serialize_mode) {
  case SERIALIZE_HEADER:
    switch (r_state) {
...
void Document::write_header(Encoder &encoder) const {
...
void Document::write_trailer(Encoder &encoder) const {
  FI_Octet *w_buf;
...
bool Document::read_header(Decoder &decoder) {
