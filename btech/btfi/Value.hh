...
public:
  ...
  // Accessors.
  FI_ValueType getType() const { return value_type; }

  size_t getCount() const { return value_count; }

  const void *getBuffer() const { return value_buf; }

  void *getBuffer() { return value_buf; }
...
template <typename T> const T *Value_cast(const Value &value) {
