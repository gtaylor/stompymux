...
DbRef mech_repair_stall_dbref(const Mech *mech);
...
float mech_jump_length(const Mech *mech);
float mech_jump_end_real_z(const Mech *mech);
int mech_jump_apex_elevation(const Mech *mech);
