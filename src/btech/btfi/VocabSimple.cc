...
FI_VocabIndex VocabTable::acquireIndex(Entry *entry) {
...
const VocabTable::EntryRef &VocabTable::lookupIndex(FI_VocabIndex idx) const {
  if (idx < base_idx) {
    // Parent index.
    if (!parent) {
...
RA_VocabTable::TypedVocabTable *RA_VocabTable::builtin_table() {
...
RA_VocabTable::RA_VocabTable(bool read_only, FI_VocabIndex max_idx)
  ...
  static unique_ptr<Entry> entry_1(
      addStaticEntry(FI_RA_NUMERIC, "0123456789-+.e "));

  static unique_ptr<Entry> entry_2(
      addStaticEntry(FI_RA_DATE_AND_TIME, "012345789-:TZ "));
...
EA_VocabTable *EA_VocabTable::builtin_table() {
...
EA_VocabTable::EA_VocabTable(bool read_only, FI_VocabIndex max_idx)
  ...
  static unique_ptr<Entry> entry_1(
      addStaticEntry(FI_EA_HEXADECIMAL, &fi_ea_hexadecimal));

  static unique_ptr<Entry> entry_2(addStaticEntry(FI_EA_BASE64, &fi_ea_base64));

  static unique_ptr<Entry> entry_3(addStaticEntry(FI_EA_SHORT, &fi_ea_short));

  static unique_ptr<Entry> entry_4(addStaticEntry(FI_EA_INT, &fi_ea_int));

  static unique_ptr<Entry> entry_5(addStaticEntry(FI_EA_LONG, &fi_ea_long));

  static unique_ptr<Entry> entry_6(
      addStaticEntry(FI_EA_BOOLEAN, &fi_ea_boolean));

  static unique_ptr<Entry> entry_7(addStaticEntry(FI_EA_FLOAT, &fi_ea_float));

  static unique_ptr<Entry> entry_8(addStaticEntry(FI_EA_DOUBLE, &fi_ea_double));

  static unique_ptr<Entry> entry_9(addStaticEntry(FI_EA_UUID, &fi_ea_uuid));

  static unique_ptr<Entry> entry_10(addStaticEntry(FI_EA_CDATA, &fi_ea_cdata));
...
DS_VocabTable::TypedVocabTable *DS_VocabTable::builtin_table() {
...
DS_VocabTable::DS_VocabTable(bool read_only, FI_VocabIndex max_idx)
  ...
  static unique_ptr<Entry> entry_0(addStaticEntry(FI_VOCAB_INDEX_NULL, ""));
}
...
DS_VocabTable *PFX_DS_VocabTable::builtin_table() {
...
PFX_DS_VocabTable::PFX_DS_VocabTable(bool read_only, FI_VocabIndex idx)
  ...
  static unique_ptr<Entry> entry_1(addStaticEntry(FI_PFX_XML, "xml"));
}

PFX_DS_VocabTable::PFX_DS_VocabTable() : DS_VocabTable(builtin_table()) {}
...
DS_VocabTable *NSN_DS_VocabTable::builtin_table() {
...
NSN_DS_VocabTable::NSN_DS_VocabTable(bool read_only, FI_VocabIndex max_idx)
  ...
  static unique_ptr<Entry> entry_1(
      addStaticEntry(FI_NSN_XML, "http://www.w3.org/XML/1998/namespace"));
}

NSN_DS_VocabTable::NSN_DS_VocabTable() : DS_VocabTable(builtin_table()) {}
