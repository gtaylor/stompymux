...
public:
  ...
  void setStream(FI_OctetStream *out_stream) { stream = out_stream; }
  ...
  unsigned int getBitOffset() const { return num_partial_bits; }

  FI_Octet getBits() const { return partial_octet; }
...
public:
  ...
  void
  writeNSAttribute(const NSN_DS_VocabTable::TypedEntryRef &ns_name); // C.12
...
public:
  ...
  bool readNSAttribute(NSN_DS_VocabTable::TypedEntryRef &ns_name); // C.12
