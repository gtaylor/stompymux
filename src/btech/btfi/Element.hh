...
public:
  ...
  void setName(const DN_VocabTable::TypedEntryRef &name) { this->name = name; }

  void setAttributes(const Attributes &attrs) { w_attrs = &attrs; }

  // Get element properties.
  const DN_VocabTable::TypedEntryRef &getName() const { return name; }

  const Attributes &getAttributes() const { return r_attrs; }
...
private:
  ...
  enum { RESET_ATTR_STATE, MAIN_ATTR_STATE, END_ATTR_STATE } r_attr_state;
