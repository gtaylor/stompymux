...
int fi_init_encoding_algorithms(void) {
  ...
  if (sample_bytes[0] == 0xFE && sample_bytes[1] == 0xDC &&
      sample_bytes[2] == 0xBA && sample_bytes[3] == 0x98 &&
      sample_bytes[4] == 0x76 && sample_bytes[5] == 0x54 &&
      sample_bytes[6] == 0x32 && sample_bytes[7] == 0x10) {
    /* Big endian.  */
    is_big_endian = 1;
  } else if (sample_bytes[0] == 0x10 && sample_bytes[1] == 0x32 &&
             sample_bytes[2] == 0x54 && sample_bytes[3] == 0x76 &&
             sample_bytes[4] == 0x98 && sample_bytes[5] == 0xBA &&
             sample_bytes[6] == 0xDC && sample_bytes[7] == 0xFE) {
    /* Little endian.  */
    is_big_endian = 0;
  } else {
...
static int copy_encoded_size(FI_EncodingContext *, const FI_Value *);
static int copy_encode(FI_EncodingContext *, FI_Octet *, const FI_Value *);
static int copy_decode(FI_EncodingContext *, FI_Value *, FI_Length,
                       const FI_Octet *);

static int copy_encoded_size_items(FI_EncodingContext *, const FI_Value *,
                                   size_t);

static int swap_16_encode(FI_EncodingContext *, FI_Octet *, const FI_Value *);
static void swap_16_decode(FI_Value *, FI_Length, const FI_Octet *);

static int swap_32_encode(FI_EncodingContext *, FI_Octet *, const FI_Value *);
static void swap_32_decode(FI_Value *, FI_Length, const FI_Octet *);

static int swap_64_encode(FI_EncodingContext *, FI_Octet *, const FI_Value *);
...
const FI_EncodingAlgorithm fi_ea_hexadecimal = {
    0, copy_encoded_size, copy_encode, copy_decode}; /* fi_ea_hexadecimal */

const FI_EncodingAlgorithm fi_ea_base64 = {0, copy_encoded_size, copy_encode,
                                           copy_decode}; /* fi_ea_base64 */
...
static int encoded_size_16(FI_EncodingContext *context, const FI_Value *src) {
  return copy_encoded_size_items(context, src, 2);
}

static int encoded_size_32(FI_EncodingContext *context, const FI_Value *src) {
  return copy_encoded_size_items(context, src, 4);
}

static int encoded_size_64(FI_EncodingContext *context, const FI_Value *src) {
  return copy_encoded_size_items(context, src, 8);
}

static int decode_short(FI_EncodingContext *context, FI_Value *dst,
...
static int decode_int(FI_EncodingContext *context, FI_Value *dst,
                      FI_Length src_len, const FI_Octet *src) {
...
static int decode_long(FI_EncodingContext *context, FI_Value *dst,
                       FI_Length src_len, const FI_Octet *src) {
...
const FI_EncodingAlgorithm fi_ea_short = {0, encoded_size_16, swap_16_encode,
                                          decode_short}; /* fi_ea_short */

const FI_EncodingAlgorithm fi_ea_int = {0, encoded_size_32, swap_32_encode,
                                        decode_int}; /* fi_ea_int */

const FI_EncodingAlgorithm fi_ea_long = {0, encoded_size_32, swap_64_encode,
                                         decode_long}; /* fi_ea_long */
...
static int decode_float(FI_EncodingContext *context, FI_Value *dst,
                        FI_Length src_len, const FI_Octet *src) {
...
static int decode_double(FI_EncodingContext *context, FI_Value *dst,
                         FI_Length src_len, const FI_Octet *src) {
...
const FI_EncodingAlgorithm fi_ea_float = {0, encoded_size_32, swap_32_encode,
                                          decode_float}; /* fi_ea_float */

const FI_EncodingAlgorithm fi_ea_double = {0, encoded_size_64, swap_64_encode,
                                           decode_double}; /* fi_ea_double */
...
static int copy_encoded_size(FI_EncodingContext *context, const FI_Value *src) {
  return copy_encoded_size_items(context, src, 1);
}

static int copy_encode(FI_EncodingContext *context, FI_Octet *dst,
                       const FI_Value *src) {
  memcpy(dst, fi_get_value(src), fi_get_value_count(src));
  return 1;
}

static int copy_decode(FI_EncodingContext *context, FI_Value *dst,
                       FI_Length src_len, const FI_Octet *src) {
...
static int copy_encoded_size_items(FI_EncodingContext *context,
...
static void swap_16(unsigned char *dst, const unsigned char *src, size_t len) {
  size_t ii;
...
static void swap_32(unsigned char *dst, const unsigned char *src, size_t len) {
  size_t ii;
...
static void swap_64(unsigned char *dst, const unsigned char *src, size_t len) {
  size_t ii;
...
static int swap_16_encode(FI_EncodingContext *context, FI_Octet *dst,
                          const FI_Value *src) {
...
static void swap_16_decode(FI_Value *dst, FI_Length src_len,
                           const FI_Octet *src) {
  swap_16(fi_get_value_buffer(dst), src, src_len);
}

static int swap_32_encode(FI_EncodingContext *context, FI_Octet *dst,
                          const FI_Value *src) {
...
static void swap_32_decode(FI_Value *dst, FI_Length src_len,
                           const FI_Octet *src) {
  swap_32(fi_get_value_buffer(dst), src, src_len);
}

static int swap_64_encode(FI_EncodingContext *context, FI_Octet *dst,
                          const FI_Value *src) {
...
static void swap_64_decode(FI_Value *dst, FI_Length src_len,
                           const FI_Octet *src) {
...
static int dummy_encoded_size(FI_EncodingContext *context,
                              const FI_Value *src) {
  /* Always fails.  */
  return 0;
}

static int dummy_encode(FI_EncodingContext *context, FI_Octet *dst,
                        const FI_Value *src) {
  /* Always fails.  */
  return 0;
}

static int dummy_decode(FI_EncodingContext *context, FI_Value *dst,
                        FI_Length src_len, const FI_Octet *src) {
  /* Always fails.  */
  return 0;
}

const FI_EncodingAlgorithm fi_ea_boolean = {0, dummy_encoded_size, dummy_encode,
                                            dummy_decode}; /* fi_ea_boolean */

const FI_EncodingAlgorithm fi_ea_uuid = {0, dummy_encoded_size, dummy_encode,
                                         dummy_decode}; /* fi_ea_uuid */

const FI_EncodingAlgorithm fi_ea_cdata = {0, dummy_encoded_size, dummy_encode,
                                          dummy_decode}; /* fi_ea_cdata */
