...
char *section_configs[] = {"Case", "Destroyed", NULL};

char *move_types[] = {"Biped", "Track", "Wheel", "Hover", "VTOL", "Hull",
                      "Foil",  "Fly",   "Quad",  "Sub",   "None", NULL};

char *mech_types[] = {"Mech",        "Vehicle",           "VTOL",
...
char *crit_ammo_modes[] = {"LBX/Cluster",
                           "Artemis/Mine",
                           "Narc/Smoke",
                           "Cluster",
                           "Mine",
...
/* 'specials' is *full* */
char *specials[] = {"TripleMyomerTech",
                    "CL_AMS",
                    "IS_AMS",
                    "DoubleHS",
                    "Masc",
...
char *infantry_specials[] = {"Swarm_Attack_Tech",
                             "Mount_Friends_Tech",
                             "AntiLeg_Attack_Tech",
...
char *infspecialsabrev[] = {"SWARM",    "MFRIEND",  "ALEG",     "PSTEALTH",
                            "KSTEALTH", "ASTEALTH", "ISTEALTH", "2STEALTH",
                            "MJPACK",   "CJPACK",   NULL};
