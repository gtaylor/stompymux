...
/*! \todo {Should really do away with this some how but i'm being lazy right
 * now} */
#define Clear(a)                                                               \
...
} auto_cmds[] = {{"auto", "autogun", 1, 0, auto_radio_command_autogun},
 ...
 */
void auto_radio_command_autogun(AUTO *autopilot, MECH *mech, char **args,
                                int argc, char *mesg) {
 ...
 */
void auto_radio_command_chasetarg(AUTO *autopilot, MECH *mech, char **args,
                                  int argc, char *mesg) {
 ...
 */
void auto_radio_command_dgoto(AUTO *autopilot, MECH *mech, char **args,
                              int argc, char *mesg) {
 ...
 */
void auto_radio_command_dropoff(AUTO *autopilot, MECH *mech, char **args,
                                int argc, char *mesg) {
 ...
 */
void auto_radio_command_enterbase(AUTO *autopilot, MECH *mech, char **args,
                                  int argc, char *mesg) {
 ...
 */
void auto_radio_command_follow(AUTO *autopilot, MECH *mech, char **args,
                               int argc, char *mesg) {
 ...
 */
void auto_radio_command_goto(AUTO *autopilot, MECH *mech, char **args, int argc,
                             char *mesg) {
 ...
 */
void auto_radio_command_heading(AUTO *autopilot, MECH *mech, char **args,
                                int argc, char *mesg) {
 ...
 */
void auto_radio_command_help(AUTO *autopilot, MECH *mech, char **args, int argc,
                             char *mesg) {
 ...
 */
void auto_radio_command_hide(AUTO *autopilot, MECH *mech, char **args, int argc,
                             char *mesg) {
 ...
 */
void auto_radio_command_leavebase(AUTO *autopilot, MECH *mech, char **args,
                                  int argc, char *mesg) {
 ...
 */
void auto_radio_command_ogoto(AUTO *autopilot, MECH *mech, char **args,
                              int argc, char *mesg) {
 ...
 */
void auto_radio_command_position(AUTO *autopilot, MECH *mech, char **args,
                                 int argc, char *mesg) {
 ...
 */
void auto_radio_command_prone(AUTO *autopilot, MECH *mech, char **args,
                              int argc, char *mesg) {
...
void auto_radio_command_report(AUTO *autopilot, MECH *mech, char **args,
                               int argc, char *mesg) {
 ...
 * its sensors
 */
void auto_radio_command_sensor(AUTO *autopilot, MECH *mech, char **args,
                               int argc, char *mesg) {
 ...
 */
void auto_radio_command_shutdown(AUTO *autopilot, MECH *mech, char **args,
                                 int argc, char *mesg) {
 ...
 */
void auto_radio_command_speed(AUTO *autopilot, MECH *mech, char **args,
                              int argc, char *mesg) {
 ...
 */
void auto_radio_command_stand(AUTO *autopilot, MECH *mech, char **args,
                              int argc, char *mesg) {
 ...
 */
void auto_radio_command_startup(AUTO *autopilot, MECH *mech, char **args,
                                int argc, char *mesg) {
 ...
 */
void auto_radio_command_stop(AUTO *autopilot, MECH *mech, char **args, int argc,
                             char *mesg) {
 ...
 */
void auto_radio_command_sweight(AUTO *autopilot, MECH *mech, char **args,
                                int argc, char *mesg) {
