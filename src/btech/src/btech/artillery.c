...
void blast_hit_hexf(MAP *map, int dam, int singlehitsize, int heatdam, float fx,
                    float fy, float tfx, float tfy, char *tomsg, char *otmsg,
...
void blast_hit_hex(MAP *map, int dam, int singlehitsize, int heatdam, int fx,
                   int fy, int tx, int ty, char *tomsg, char *otmsg, int table,
...
void blast_hit_hexes(MAP *map, int dam, int singlehitsize, int heatdam, int tx,
                     int ty, char *tomsg, char *otmsg, char *tomsg1,
...
static void artillery_hit_hex(MAP *map, artillery_shot *s, int type, int mode,
                              int dam, int tx, int ty, int isdirect) {
  char buf1[LBUF_SIZE];
  char buf2[LBUF_SIZE];
