...
SEEFUNC(vislight_see,
        r > (c * ((!l && t && IsLit(t)) ? 3 : 1))
            ? 0
            : (100 - (r / 3)) / ((t && (MechType(t) == CLASS_BSUIT ||
                                        MechType(t) == CLASS_MW))
                                     ? 3
                                     : 1));
...
SEEFUNC(liteamp_see,
        ((!l && r > (2 * c)) ? 0
         : (l && r > c)      ? 0
                             : (70 - r)) /
            ((t && (MechType(t) == CLASS_BSUIT || MechType(t) == CLASS_MW))
                 ? 3
                 : 1));
...
CSEEFUNC(vislight_csee, !(map->sensorflags & (1 << SENSOR_VIS)) &&
                            ...
                            (!t || MechZ(t) >= 0 ||
                             ActualElevation(getMap(t->mapindex), MechX(t),
                                             MechY(t), t) >= 0.0 ||
...
CSEEFUNC(infrared_csee,
         !(map->sensorflags & (1 << SENSOR_IR)) &&
             !(f & (MECHLOSFLAG_BLOCK | MECHLOSFLAG_FIRE)) &&
             MechLOSFlag_WoodCount(f) < 6 &&
             (!t || (MechType(t) != CLASS_BSUIT && MechType(t) != CLASS_MW)));
...
CSEEFUNC(electrom_csee, !(map->sensorflags & (1 << SENSOR_EM)) &&
                            ...
                            MechLOSFlag_WoodCount(f) < 8 &&
                            !AnyECMDisturbed(m) &&
                            (!t || (MechType(t) != CLASS_MW)));
...
CSEEFUNC(seismic_csee,
         !(map->sensorflags & (1 << SENSOR_SE)) && t && (!Jumping(m)) &&
             ...
             (((MechMove(m) != MOVE_VTOL) ||
              ...
              Started(t) && !Jumping(t) && (MechType(t) != CLASS_BSUIT) &&
...
CSEEFUNC(radar_csee, !(map->sensorflags & (1 << SENSOR_RA)) && t &&
                         MechZ(t) > 2 && !(f & MECHLOSFLAG_BLOCK) &&
...
#define HEAT_MODIFIER(a)                                                       \
  ((a) <= 0 ? 2 : (a) > 50 ? -2 : (a) > 35 ? -1 : (a) > 20 ? 0 : 1)
#else

/*
#define HEAT_MODIFIER(a) ((a) <= 7 ? 2 : (a) > 28 ? -2 : (a) > 21 ? -1 : (a) >
14 ? 0 : 1)
*/

#define HEAT_MODIFIER(a)                                                       \
  ((a) <= 7 ? 2 : (a) <= 10 ? 1 : (a) <= 15 ? 0 : (a) <= 22 ? -1 : -2)
#endif
