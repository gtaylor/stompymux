...
static void sketch_tac_map(char *buf, MAP *map, MECH *mech, int sx, int sy,
...
static void sketch_tac_mechs(char *buf, MAP *map, MECH *player_mech, int sx,
...
static void sketch_tac_dslz(char *buf, MAP *map, MECH *mech, int sx, int sy,
                            int wx, int wy, int dispcols, int top_offset,
                            int left_offset, int cliff_size, int docolour) {
  char *pos = buf + top_offset * dispcols + left_offset;
  int y, x;
  int oddcol1 = is_oddcol(sx);
...
static void sketch_tac_mines(char *buf, MAP *map, MECH *mech, int sx, int sy,
                             int wx, int wy, int dispcols, int top_offset,
                             int left_offset) {
  char *pos = buf + top_offset * dispcols + left_offset;
  int y, x;
