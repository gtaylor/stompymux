...
void tech_checkstatus(DbRef player, Mech *mech, char *buffer);
...
void tech_magic(DbRef player, Mech *facility, char *buffer);
void tech_fixextra(DbRef player, Mech *facility, char *buffer);
