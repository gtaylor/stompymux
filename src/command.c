...
CMDENT command_table[] = {
	...
	{(char *) "@alias", NULL, CA_NO_SLAVE, 0, CS_TWO_ARG,
	 do_alias},
	{(char *) "@attribute", attrib_sw, CA_GOD, 0, CS_TWO_ARG | CS_INTERP,
	 do_attribute},
	{(char *) "@boot", boot_sw, CA_NO_SLAVE, 0,
	 CS_ONE_ARG | CS_INTERP, do_boot},
	{(char *) "@cboot", NULL, CA_NO_SLAVE, 0, CS_TWO_ARG,
	 do_chboot},
	{(char *) "@ccharge", NULL, CA_NO_SLAVE, 1, CS_TWO_ARG,
	 do_editchannel},
	{(char *) "@cchown", NULL, CA_NO_SLAVE, 0, CS_TWO_ARG,
	 do_editchannel},
	{(char *) "@ccreate", NULL, CA_NO_SLAVE, 0, CS_ONE_ARG,
	 do_createchannel},
	{(char *) "@cdestroy", NULL, CA_NO_SLAVE, 0, CS_ONE_ARG,
	 do_destroychannel},
	{(char *) "@cemit", cemit_sw, CA_NO_SLAVE, 0, CS_TWO_ARG,
	 do_cemit},
	{(char *) "@chown", NULL, CA_NO_SLAVE | CA_GBL_BUILD,
	...
	{(char *) "@clone", clone_sw,
	 CA_NO_SLAVE | CA_GBL_BUILD | CA_CONTENTS,
	...
	{(char *) "@dig", dig_sw, CA_NO_SLAVE | CA_GBL_BUILD,
	...
	{(char *) "@dolist", dolist_sw, CA_GBL_INTERP,
	 ...
	 do_dolist},
	{(char *) "@drain", NULL, CA_GBL_INTERP | CA_NO_SLAVE,
	...
	{(char *) "@emit", emit_sw, CA_LOCATION | CA_NO_SLAVE,
	 SAY_EMIT, CS_ONE_ARG | CS_INTERP, do_say},
	{(char *) "@enable", NULL, CA_WIZARD, GLOB_ENABLE, CS_ONE_ARG, do_global},
	{(char *) "@entrances", NULL, 0, 0, CS_ONE_ARG | CS_INTERP,
	 do_entrances},
	{(char *) "@femit", femit_sw, CA_LOCATION | CA_NO_SLAVE,
	...
	{(char *) "@force", NULL, CA_NO_SLAVE | CA_GBL_INTERP,
	...
	{(char *) "@link", NULL, CA_NO_SLAVE | CA_GBL_BUILD,
	...
	{(char *) "@newpassword", NULL, CA_WIZARD, PASS_ANY, CS_TWO_ARG,
	 do_newpassword},
	{(char *) "@notify", notify_sw, CA_GBL_INTERP | CA_NO_SLAVE,
	 0, CS_TWO_ARG, do_notify},
	{(char *) "@oemit", NULL, CA_LOCATION | CA_NO_SLAVE,
	...
	{(char *) "@pageunlock", NULL, CA_NO_SLAVE, 0, CS_ONE_ARG | CS_INTERP,
	 do_pageunlock},
	{(char *) "@parent", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0,
	 CS_TWO_ARG, do_parent},
	{(char *) "@password", NULL, 0, PASS_MINE, CS_TWO_ARG,
	 do_password},
	...
	{(char *) "@robot", NULL,
	 CA_NO_SLAVE | CA_GBL_BUILD | CA_PLAYER, PCRE_ROBOT,
	 CS_TWO_ARG, do_pcreate},
	{(char *) "@search", NULL, 0, SRCH_SEARCH, CS_ONE_ARG | CS_NOINTERP,
	 do_search},
	{(char *) "@set", set_sw, CA_NO_SLAVE | CA_GBL_BUILD, 0,
	 CS_TWO_ARG, do_set},
	...
	{(char *) "delcom", NULL, CA_NO_SLAVE | CA_NO_IC, 0, CS_ONE_ARG,
	 do_delcom},
	{(char *) "drop", drop_sw,
	 CA_NO_SLAVE | CA_CONTENTS | CA_LOCATION, 0,
	...
	{(char *) "examine", examine_sw, 0, 0, CS_ONE_ARG | CS_INTERP,
	 do_examine},
	{(char *) "get", get_sw, CA_LOCATION, 0,
	 CS_ONE_ARG | CS_INTERP, do_get},
	{(char *) "give", give_sw, CA_LOCATION, 0,
    ...
    {(char *) "\\", NULL, CA_LOCATION | CF_DARK | CA_NO_SLAVE,
