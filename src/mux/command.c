...
CMDENT command_table[] = {
    ...
    {(char *)"@alias", NULL, 0, 0, CS_TWO_ARG, do_alias},
    ...
    {(char *)"@coflags", NULL, 0, 4, CS_TWO_ARG, do_editchannel},
    {(char *)"@cpattr", NULL, CA_GBL_BUILD, 0,
    ...
    {(char *)"@cset", cset_sw, 0, 0, CS_TWO_ARG | CS_INTERP,
     do_chopen},
    {(char *)"@cut", NULL, CA_WIZARD | CA_LOCATION, 0, CS_ONE_ARG | CS_INTERP,
     do_cut},
    {(char *)"@cwho", NULL, 0, 0, CS_ONE_ARG, do_channelwho},
    ...
    {(char *)"@dig", dig_sw, CA_GBL_BUILD, 0,
    ...
    {(char *)"@mvattr", NULL, CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_ARGV, do_mvattr},
    {(char *)"@name", NULL, CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_INTERP, do_name},
    {(char *)"@newpassword", NULL, CA_WIZARD, PASS_ANY, CS_TWO_ARG,
     do_newpassword},
    {(char *)"@notify", notify_sw, CA_GBL_INTERP, 0, CS_TWO_ARG,
     do_notify},
    {(char *)"@oemit", NULL, CA_LOCATION, PEMIT_OEMIT,
     CS_TWO_ARG | CS_INTERP, do_pemit},
    {(char *)"@open", open_sw, CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_ARGV | CS_INTERP, do_open},
    {(char *)"@pagelock", NULL, 0, 0, CS_TWO_ARG | CS_INTERP,
     do_pagelock},
    {(char *)"@pageunlock", NULL, 0, 0, CS_ONE_ARG | CS_INTERP,
     do_pageunlock},
    {(char *)"@parent", NULL, CA_GBL_BUILD, 0, CS_TWO_ARG,
     do_parent},
    ...
    {(char *)"@pemit", pemit_sw, 0, PEMIT_PEMIT,
     CS_TWO_ARG | CS_INTERP, do_pemit},
    {(char *)"@npemit", pemit_sw, 0, PEMIT_PEMIT,
    ...
    {(char *)"@robot", NULL, CA_GBL_BUILD | CA_PLAYER, PCRE_ROBOT,
     CS_TWO_ARG, do_pcreate},
    ...
    {(char *)"@trigger", trig_sw, CA_GBL_INTERP, 0, CS_TWO_ARG | CS_ARGV,
     do_trigger},
    {(char *)"@unlink", NULL, CA_GBL_BUILD, 0,
     CS_ONE_ARG | CS_INTERP, do_unlink},
    {(char *)"@unlock", lock_sw, 0, 0, CS_ONE_ARG | CS_INTERP,
     do_unlock},
    {(char *)"@verb", NULL, CA_GBL_INTERP, 0,
    ...
    {(char *)"@wall", wall_sw, CA_ANNOUNCE, SAY_SHOUT, CS_ONE_ARG | CS_INTERP,
     do_say},
    {(char *)"@wipe", wall_sw, CA_GBL_BUILD, 0,
     CS_ONE_ARG | CS_INTERP, do_wipe},
    {(char *)"addcom", NULL, CA_NO_IC, 0, CS_TWO_ARG, do_addcom},
    {(char *)"allcom", NULL, CA_NO_IC, 0, CS_ONE_ARG, do_allcom},
    {(char *)"comlist", NULL, CA_NO_IC, 0, CS_NO_ARGS,
     do_comlist},
    {(char *)"comtitle", NULL, CA_NO_IC, 0, CS_TWO_ARG,
     do_comtitle},
    {(char *)"clearcom", NULL, CA_NO_IC, 0, CS_NO_ARGS,
     do_clearcom},
    {(char *)"delcom", NULL, CA_NO_IC, 0, CS_ONE_ARG, do_delcom},
    ...
    {(char *)"look", look_sw, CA_LOCATION, LOOK_LOOK, CS_ONE_ARG | CS_INTERP,
     do_look},
    {(char *)"page", NULL, 0, 0, CS_TWO_ARG | CS_INTERP, do_page},
    {(char *)"pose", pose_sw, CA_LOCATION, SAY_POSE,
     CS_ONE_ARG | CS_INTERP, do_say},
    {(char *)"say", NULL, CA_LOCATION, SAY_SAY,
     CS_ONE_ARG | CS_INTERP, do_say},
    {(char *)"think", NULL, 0, 0, CS_ONE_ARG, do_think},
    {(char *)"use", NULL, CA_GBL_INTERP, 0,
    ...
    {(char *)"\\", NULL, CA_LOCATION | CF_DARK, SAY_PREFIX,
     CS_ONE_ARG | CS_INTERP, do_say},
    {(char *)"#", NULL, CA_GBL_INTERP | CF_DARK, 0,
    ...
    {(char *)"\"", NULL, CA_LOCATION | CF_DARK, SAY_PREFIX,
     CS_ONE_ARG | CS_INTERP | CS_LEADIN, do_say},
    {(char *)"&", NULL, CF_DARK, 0, CS_TWO_ARG | CS_LEADIN,
     do_setvattr},
