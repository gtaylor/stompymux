...
NAMETAB attrib_sw[] = {{(char *)"access", 1, CA_GOD, ATTRIB_ACCESS},
                       {(char *)"delete", 1, CA_GOD, ATTRIB_DELETE},
                       {(char *)"rename", 1, CA_GOD, ATTRIB_RENAME},
                       {NULL, 0, 0, 0}};

NAMETAB boot_sw[] = {{(char *)"port", 1, CA_WIZARD, BOOT_PORT | SW_MULTIPLE},
                     {(char *)"quiet", 1, CA_WIZARD, BOOT_QUIET | SW_MULTIPLE},
                     {NULL, 0, 0, 0}};

NAMETAB cemit_sw[] = {{(char *)"noheader", 1, CA_PUBLIC, CEMIT_NOHEADER},
                      {NULL, 0, 0, 0}};
...
NAMETAB clist_sw[] = {{(char *)"full", 0, CA_PUBLIC, CLIST_FULL},
                      {NULL, 0, 0, 0}};

NAMETAB cstatus_sw[] = {{(char *)"full", 0, CA_PUBLIC, CSTATUS_FULL},
                        {NULL, 0, 0, 0}};

NAMETAB cset_sw[] = {{(char *)"public", 2, CA_PUBLIC, CSET_PUBLIC},
...
NAMETAB decomp_sw[] = {{(char *)"dbref", 1, CA_PUBLIC, DECOMP_DBREF},
                       {NULL, 0, 0, 0}};

NAMETAB destroy_sw[] = {{(char *)"override", 8, CA_PUBLIC, DEST_OVERRIDE},
...
NAMETAB drop_sw[] = {{(char *)"quiet", 1, CA_PUBLIC, DROP_QUIET},
                     {NULL, 0, 0, 0}};
...
NAMETAB emit_sw[] = {{(char *)"here", 1, CA_PUBLIC, SAY_HERE | SW_MULTIPLE},
                     {(char *)"room", 1, CA_PUBLIC, SAY_ROOM | SW_MULTIPLE},
                     {NULL, 0, 0, 0}};

NAMETAB enter_sw[] = {{(char *)"quiet", 1, CA_PUBLIC, MOVE_QUIET},
                      {NULL, 0, 0, 0}};

NAMETAB examine_sw[] = {{(char *)"brief", 1, CA_PUBLIC, EXAM_BRIEF},
                        {(char *)"debug", 1, CA_WIZARD, EXAM_DEBUG},
                        {(char *)"full", 1, CA_PUBLIC, EXAM_LONG},
                        {(char *)"parent", 1, CA_PUBLIC, EXAM_PARENT},
                        {NULL, 0, 0, 0}};

NAMETAB femit_sw[] = {{(char *)"here", 1, CA_PUBLIC, PEMIT_HERE | SW_MULTIPLE},
...
NAMETAB fpose_sw[] = {{(char *)"default", 1, CA_PUBLIC, 0},
                      {(char *)"nospace", 1, CA_PUBLIC, SAY_NOSPACE},
                      {NULL, 0, 0, 0}};

NAMETAB function_sw[] = {{(char *)"privileged", 3, CA_WIZARD, FN_PRIV},
                         {(char *)"preserve", 3, CA_WIZARD, FN_PRES},
                         {NULL, 0, 0, 0}};

NAMETAB get_sw[] = {{(char *)"quiet", 1, CA_PUBLIC, GET_QUIET},
                    {NULL, 0, 0, 0}};

NAMETAB give_sw[] = {{(char *)"quiet", 1, CA_WIZARD, GIVE_QUIET},
                     {NULL, 0, 0, 0}};

NAMETAB goto_sw[] = {{(char *)"quiet", 1, CA_PUBLIC, MOVE_QUIET},
                     {NULL, 0, 0, 0}};

NAMETAB halt_sw[] = {{(char *)"all", 1, CA_PUBLIC, HALT_ALL}, {NULL, 0, 0, 0}};
...
NAMETAB open_sw[] = {{(char *)"inventory", 1, CA_PUBLIC, OPEN_INVENTORY},
...
NAMETAB pose_sw[] = {{(char *)"default", 1, CA_PUBLIC, 0},
                     {(char *)"nospace", 1, CA_PUBLIC, SAY_NOSPACE},
                     {NULL, 0, 0, 0}};

NAMETAB ps_sw[] = {{(char *)"all", 1, CA_PUBLIC, PS_ALL | SW_MULTIPLE},
...
NAMETAB stats_sw[] = {{(char *)"all", 1, CA_PUBLIC, STAT_ALL},
...
NAMETAB switch_sw[] = {{(char *)"all", 1, CA_PUBLIC, SWITCH_ANY},
                       {(char *)"default", 1, CA_PUBLIC, SWITCH_DEFAULT},
                       {(char *)"first", 1, CA_PUBLIC, SWITCH_ONE},
                       {NULL, 0, 0, 0}};

NAMETAB teleport_sw[] = {{(char *)"loud", 1, CA_PUBLIC, TELEPORT_DEFAULT},
...
CMDENT command_table[] = {
    ...
    {(char *)"@alias", NULL, CA_NO_SLAVE, 0, CS_TWO_ARG, do_alias},
    {(char *)"@attribute", attrib_sw, CA_GOD, 0, CS_TWO_ARG | CS_INTERP,
     do_attribute},
    {(char *)"@boot", boot_sw, CA_NO_SLAVE, 0, CS_ONE_ARG | CS_INTERP, do_boot},
    {(char *)"@cboot", NULL, CA_NO_SLAVE, 0, CS_TWO_ARG, do_chboot},
    {(char *)"@ccharge", NULL, CA_NO_SLAVE, 1, CS_TWO_ARG, do_editchannel},
    {(char *)"@cchown", NULL, CA_NO_SLAVE, 0, CS_TWO_ARG, do_editchannel},
    {(char *)"@ccreate", NULL, CA_NO_SLAVE, 0, CS_ONE_ARG, do_createchannel},
    {(char *)"@cdestroy", NULL, CA_NO_SLAVE, 0, CS_ONE_ARG, do_destroychannel},
    {(char *)"@cemit", cemit_sw, CA_NO_SLAVE, 0, CS_TWO_ARG, do_cemit},
    {(char *)"@chown", NULL, CA_NO_SLAVE | CA_GBL_BUILD, CHOWN_ONE,
     CS_TWO_ARG | CS_INTERP, do_chown},
    {(char *)"@chownall", NULL, CA_WIZARD | CA_GBL_BUILD, CHOWN_ALL,
     CS_TWO_ARG | CS_INTERP, do_chownall},
    {(char *)"@chzone", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_INTERP, do_chzone},
    {(char *)"@clone", clone_sw, CA_NO_SLAVE | CA_GBL_BUILD | CA_CONTENTS, 0,
    ...
    {(char *)"@cpattr", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_ARGV, do_cpattr},
    {(char *)"@cpflags", NULL, CA_NO_SLAVE, 3, CS_TWO_ARG, do_editchannel},
    {(char *)"@create", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_CONTENTS, 0,
    ...
    {(char *)"@destroy", destroy_sw, CA_NO_SLAVE | CA_GBL_BUILD, DEST_ONE,
     CS_ONE_ARG | CS_INTERP, do_destroy},
    /*{(char *)"@destroyall", NULL, CA_WIZARD|CA_GBL_BUILD,
       DEST_ALL, CS_ONE_ARG, do_destroy}, */
    {(char *)"@dig", dig_sw, CA_NO_SLAVE | CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_ARGV | CS_INTERP, do_dig},
    ...
    {(char *)"@dolist", dolist_sw, CA_GBL_INTERP, 0,
     ...
     do_dolist},
    {(char *)"@drain", NULL, CA_GBL_INTERP | CA_NO_SLAVE, NFY_DRAIN, CS_TWO_ARG,
     do_notify},
    {(char *)"@dump", dump_sw, CA_WIZARD, 0, CS_NO_ARGS, do_dump},
    {(char *)"@edit", NULL, CA_NO_SLAVE, 0,
     CS_TWO_ARG | CS_ARGV | CS_STRIP_AROUND, do_edit},
    {(char *)"@emit", emit_sw, CA_LOCATION | CA_NO_SLAVE, SAY_EMIT,
     CS_ONE_ARG | CS_INTERP, do_say},
    {(char *)"@enable", NULL, CA_WIZARD, GLOB_ENABLE, CS_ONE_ARG, do_global},
    {(char *)"@entrances", NULL, 0, 0, CS_ONE_ARG | CS_INTERP, do_entrances},
    {(char *)"@femit", femit_sw, CA_LOCATION | CA_NO_SLAVE, PEMIT_FEMIT,
    ...
    {(char *)"@force", NULL, CA_NO_SLAVE | CA_GBL_INTERP, FRC_COMMAND,
    ...
    {(char *)"@link", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_INTERP, do_link},
    ...
    {(char *)"@mvattr", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_ARGV, do_mvattr},
    {(char *)"@name", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0,
     CS_TWO_ARG | CS_INTERP, do_name},
    {(char *)"@newpassword", NULL, CA_WIZARD, PASS_ANY, CS_TWO_ARG,
     do_newpassword},
    {(char *)"@notify", notify_sw, CA_GBL_INTERP | CA_NO_SLAVE, 0, CS_TWO_ARG,
     do_notify},
    {(char *)"@oemit", NULL, CA_LOCATION | CA_NO_SLAVE, PEMIT_OEMIT,
     CS_TWO_ARG | CS_INTERP, do_pemit},
    {(char *)"@open", open_sw, CA_NO_SLAVE | CA_GBL_BUILD, 0,
    ...
    {(char *)"@pageunlock", NULL, CA_NO_SLAVE, 0, CS_ONE_ARG | CS_INTERP,
     do_pageunlock},
    {(char *)"@parent", NULL, CA_NO_SLAVE | CA_GBL_BUILD, 0, CS_TWO_ARG,
     do_parent},
    {(char *)"@password", NULL, 0, PASS_MINE, CS_TWO_ARG, do_password},
    {(char *)"@pcreate", NULL, CA_WIZARD | CA_GBL_BUILD, PCRE_PLAYER,
     CS_TWO_ARG, do_pcreate},
    {(char *)"@pemit", pemit_sw, CA_NO_SLAVE, PEMIT_PEMIT,
     CS_TWO_ARG | CS_INTERP, do_pemit},
    {(char *)"@npemit", pemit_sw, CA_NO_SLAVE, PEMIT_PEMIT,
    ...
    {(char *)"@robot", NULL, CA_NO_SLAVE | CA_GBL_BUILD | CA_PLAYER, PCRE_ROBOT,
     CS_TWO_ARG, do_pcreate},
    {(char *)"@search", NULL, 0, SRCH_SEARCH, CS_ONE_ARG | CS_NOINTERP,
     do_search},
    {(char *)"@set", set_sw, CA_NO_SLAVE | CA_GBL_BUILD, 0, CS_TWO_ARG, do_set},
    ...
    {(char *)"@wall", wall_sw, CA_ANNOUNCE, SAY_SHOUT, CS_ONE_ARG | CS_INTERP,
     do_say},
    {(char *)"@wipe", wall_sw, CA_NO_SLAVE | CA_GBL_BUILD, 0,
    ...
    {(char *)"drop", drop_sw, CA_NO_SLAVE | CA_CONTENTS | CA_LOCATION, 0,
    ...
    {(char *)"\"", NULL, CA_LOCATION | CF_DARK, SAY_PREFIX,
     CS_ONE_ARG | CS_INTERP | CS_LEADIN, do_say},
    {(char *)"&", NULL, CA_NO_SLAVE | CF_DARK, 0, CS_TWO_ARG | CS_LEADIN,
     do_setvattr},
...
void set_prefix_cmds() {
  ...
  for (i = 0; i < A_USER_START; i++)
    prefix_cmds[i] = NULL;
  prefix_cmds['"'] = (CMDENT *)hashfind((char *)"\"", &mudstate.command_htab);
  prefix_cmds[':'] = (CMDENT *)hashfind((char *)":", &mudstate.command_htab);
  prefix_cmds[';'] = (CMDENT *)hashfind((char *)";", &mudstate.command_htab);
  prefix_cmds['\\'] = (CMDENT *)hashfind((char *)"\\", &mudstate.command_htab);
  prefix_cmds['#'] = (CMDENT *)hashfind((char *)"#", &mudstate.command_htab);
...
void process_command(dbref player, dbref cause, int interactive, char *command,
  ...
  if ((prefix_cmds[i] != NULL) && command[0]) {
    process_cmdent(prefix_cmds[i], NULL, player, cause, interactive, command,
                   command, args, nargs);
    mudstate.debug_cmd = cmdsave;
    goto exit;
  }
  ...
  if ((!succ) && mudconf.have_zones && (Zone(Location(player)) != NOTHING)) {
    if (Typeof(Zone(Location(player))) == TYPE_ROOM) {
      ...
      if ((!succ) && mudconf.have_zones &&
        ...
        succ += atr_match(Zone(Location(player)), player, AMATCH_CMD, lcbuf, 1);
  }
  /*
...
static void list_options(dbref player) {
  ...
  if (!mudconf.terse_movemsg)
    raw_notify(player, "The TERSE flag suppresses enter/leave/succ/drop "
                       "messages generated by moving.");
