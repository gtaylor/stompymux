...
void object_log_header_error(EvaluationContext *evaluation, DbRef obj,
                             DbRef loc, DbRef val, bool is_object,
...
void object_log_simple_error(EvaluationContext *evaluation, DbRef obj,
