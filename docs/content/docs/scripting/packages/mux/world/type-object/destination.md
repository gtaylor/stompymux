...
being destroyed. An exit linked to the special `HOME` destination has no
concrete Object representation and raises `mux.object.invalid`, as does any
other invalid stored destination.
