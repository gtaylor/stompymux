...
| [`Object:description`](description/) | Returns the object's description. |
...
| [`Object:internal_description`](internal-description/) | Returns the object's internal description. |
| [`Object:name`](name/) | Returns the object's current name. |
| [`Object:set_name`](set-name/) | Changes the object's name. |
| [`Object:set_description`](set-description/) | Sets or clears the object's description. |
| [`Object:set_internal_description`](set-internal-description/) | Sets or clears the object's internal description. |
